...
export default function PurchaseBillFormView(props) {
    return (
        <>
        {
            props.savedItem
            ...
            <section className="info-block">
                <div className='info-header'>
                    ...
                    <div className={'small-block right ' + props.savedItem.billstatus}> 
                    {(props.savedItem.billstatus === 'underreview') ? 'Under Review' : 'Approved'}
                    </div>
                ...
                <div className="info-row">
                    ...
                    <div><span className="label">Paid Status</span> {
                        (props.savedItem.billstatus === 'approved')
                        ?
                        (
